...
- The workspace contains an unpacked plugin scaffold at the repository root that loads `custom.css` through plugin runtime instead of the HTTP bridge.
- Use Logseq Developer mode and `Load unpacked plugin` against the repository root to activate it.

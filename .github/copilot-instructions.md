...
- This workspace now contains an unpacked Logseq plugin at the repository root (`package.json`, `index.html`, `plugin.js`, `custom.css`) that loads `custom.css` with `logseq.provideStyle`.

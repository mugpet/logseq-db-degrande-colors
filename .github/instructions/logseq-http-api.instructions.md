...
- Keep a manual graph-sync action in the Degrande panel and a lightweight background refresh fallback, because remote sync can arrive without a reliably filterable `txData` payload.
